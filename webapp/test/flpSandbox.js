		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#fragmentprojectfragmentdialogproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"fragmentprojectfragmentdialogproject-display": {
								"semanticObject": "fragmentprojectfragmentdialogproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=fragmentproject.fragmentdialogproject",
									"url": sap.ui.require.toUrl("fragmentproject/fragmentdialogproject")
								}
							}
						}
					}
